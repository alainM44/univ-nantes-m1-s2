...
/** 
 * Test case TC_AllInstanceOfUseCase_6 for Book system 
 */

public class TC_AllInstanceOfUseCase_6 extends TestCase {

	protected BookSystem bookSystem;

	// constructor
	public TC_AllInstanceOfUseCase_6(String name) {
		super(name);
	}
...
// end borrow(b:Book; u:User)
	...
	public static void main(String[] args) {
		junit.swingui.TestRunner.run(TC_AllInstanceOfUseCase_6.class);
	}
