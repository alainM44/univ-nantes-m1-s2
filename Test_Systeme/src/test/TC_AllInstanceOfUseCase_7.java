...
/** 
 * Test case TC_AllInstanceOfUseCase_7 for Book system 
 */

public class TC_AllInstanceOfUseCase_7 extends TestCase {

	protected BookSystem bookSystem;

	// constructor
	public TC_AllInstanceOfUseCase_7(String name) {
		super(name);
	}
	...
	public void testTC_AllInstanceOfUseCase_7() {
...
// end return(b:Book; u:User)
	...
	public static void main(String[] args) {
		junit.swingui.TestRunner.run(TC_AllInstanceOfUseCase_7.class);
	}
