...
/** 
 * Test case TC_AllInstanceOfUseCase_3 for Book system 
 */

public class TC_AllInstanceOfUseCase_3 extends TestCase {

	protected BookSystem bookSystem;

	// constructor
	public TC_AllInstanceOfUseCase_3(String name) {
		super(name);
	}
	...
	public void testTC_AllInstanceOfUseCase_3() {
...
// end deliver(b : Book)
	...
	public static void main(String[] args) {
		junit.swingui.TestRunner.run(TC_AllInstanceOfUseCase_3.class);
	}
