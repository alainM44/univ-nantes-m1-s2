...
public class Case
{
  ...
  // *****************************************************************
  public boolean isOccupee() { return jeton == null; }
  public int getCouleur()
  {
    // m�thode dont le d�veloppement n'a pas encore �t� r�alis�
  ...
  //     mutateurs
  // *****************************************************************
  public void setJeton(Jeton jeton_p) {jeton = jeton_p; }
  ...
  {
    return (  Math.abs(ligne - autre_p.ligne) ==
              Math.abs(colonne - autre_p.colonne));
  }
  // *****************************************************************
  ...
  {
    return (  (ligne == autre_p.ligne + 1) &&
              (colonne == autre_p.colonne));
  }
  // *****************************************************************
