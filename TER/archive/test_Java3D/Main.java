...
//		pan.setPreferredSize(panel_size);
//
////
////		for (int i =0; i<n;i++){
////
...
////			if ((x2 < display) && (y2< display))
////				this.pave_size =new Dimension(x2-x1,y2-y1 );
////			else if ((x2 >= display) && (y2<display))
////				this.pave_size =new Dimension(display-x1,y2-y1 );
////			else if ((x2 < display) && (y2>=display))
////				this.pave_size =new Dimension(x2-x1,display-y1 );
////			else //((x2 >= display) && (y2>=display))
////				this.pave_size =new Dimension(display-x1,display-y1 );
//
//
//
