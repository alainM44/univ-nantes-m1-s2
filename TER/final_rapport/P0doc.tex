...
\end{itemize}
\clearpage
Reprenons l'exemple du problème de l'intersection de deux disques. Soient deux disques, l'un de centre $(-1,0)$ et l'autre de centre $(1,0)$. Tous deux sont de rayon $2$. L'outil RealPaver (cf. \ref{realp}) modélise un tel problème de la sorte :
\label{realprob}
\begin{verbatim} 
Constants
  x0 = -1,
...
Cependant les résolutions de problèmes par des méthodes formelles sont forcément restreintes par les possibilités du calcul symbolique et ne pourront donc pas toujours offrir de solution générale {\color{red}et de mettre en œuvre des algorithmes de complexité exponentielles.} Il n'existe par exemple pas de formules générales permettant de trouver les solutions d'un polynôme de degré supérieur ou égal à cinq.
