...
L'objectif de ce chapitre est de décrire les notions essentielles à retenir en ce début de projet d'\emph{Initiation à la recherche}. Ces notions font partie d'un même sujet d'étude, au cœur des travaux de l'équipe \textsc{OPTI}. Elles concernent le sujet des contraintes et des intervalles. %Aussi des notions d'optimisation seront abordées.
