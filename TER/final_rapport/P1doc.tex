...
\end{figure} %on ferme l'environnement figure
{\color{red}On visualise sur la figure \ref{fig:Deuxcerlces} que les solutions sont encadrées par des \og boîtes \fg{} rouges, et non réduites à des points. }
\clearpage
...
\includegraphics[scale=0.35]{img/disk-disk2}
  \caption{Comparaison graphique entre la \emph{Hull-consistance} (rouge) et la 3B-consistance (orange)} %la légende
