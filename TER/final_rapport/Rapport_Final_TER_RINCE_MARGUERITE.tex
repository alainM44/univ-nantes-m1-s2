...
\title{ {\huge \textsc{Initiation à la Recherche}} \\Master ALMA 1\up{ère} année \\\vspace{3cm} \emph{Conception et réalisation d’un logiciel interactif de visualisation de pavages 2D/3D }%\vspace{3cm}
}
