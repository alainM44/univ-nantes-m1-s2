...
\overlays{7}{
  \begin{slide}[Box]{Problématiques}
    %    \slidetextsiz
    \begin{Itemize}
      \fromSlide{2}{\item Création d'un outil de visualisation}
      \begin{Itemize}
        \fromSlide{3}{\item Données en entrée}
        \fromSlide{4}{\item Fenêtre de visualisation}
        \fromSlide{5}{\item Dimensions visualisées }
        \fromSlide{6}{\item Filtre}
        \fromSlide{7}{\item Données en sortie}
      \end{Itemize}
    \end{Itemize}
  \end{slide}
}
...
\overlays{7}{
  \begin{slide}[Box]{Reprise d'un projet de stage}
    ...
    \begin{Itemize}
      ...
      \end{Itemize}
      \vspace{1cm}
      \fromSlide{5}{\item Quelles orientations du projet choisir?}
      \begin{Itemize}
    \fromSlide{6}{\item Entamer la conception}
        \fromSlide{7}{\item Effectuer une étude des problématiques de conception }
      \end{Itemize}
    \end{Itemize}
  \end{slide}
}
...
%Chaque valeur du domaine $D_i$ associée à la variable $v_i$ est une valeur que peut potentiellement prendre $v_i$ : $\mathbf{D} = D_1 \times \dots \times D_n $.}
      \fromSlide{4}{  \item
