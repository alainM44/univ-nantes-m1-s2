...
public class Test_ColorCube extends JFrame implements WindowListener
{	 
	...
	public Test_ColorCube(int n,int display)
	{
...
public static void main(String args[])
{
	...
	Test_ColorCube myApp=new Test_ColorCube(n,display);
	...
	CpuTime = test.Test_ColorCube.getCpuTime();
