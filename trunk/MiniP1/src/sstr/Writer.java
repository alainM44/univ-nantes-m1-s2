...
public class Writer
{
			...
			String Color)
	{
		...
		this.Events += Integer.toString(Time) + " " + Event_Type
				+ Integer.toString(Line) + " " + Text + " " + Color + "\n";
	...
	public void addVLINE(int Time, int Line, String Text, String Color)
	{
		...
		this.Events += Integer.toString(Time) + " " + "VLINE"
				+ Integer.toString(Line) + " " + Text + " " + Color + "\n";
	...
	public void generateFile()
	{
		...
		try
		{
			...
			writer.write(DrawingOption + Events, 0, (DrawingOption + Events)
					.length());
