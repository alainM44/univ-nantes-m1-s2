...
import book.*;
/** 
 * Test case TC_AllInstanceOfUseCase_10 for Book system 
 */

public class TC_AllInstanceOfUseCase_10 extends TestCase {

	protected BookSystem bookSystem;

	// constructor
	public TC_AllInstanceOfUseCase_10(String name) {
		super(name);
	}
	...
	public void testTC_AllInstanceOfUseCase_10() {
...
// end borrow(b:Book; u:User)
	...
	public static void main(String[] args) {
		junit.swingui.TestRunner.run(TC_AllInstanceOfUseCase_10.class);
	}
