...
\author{ \textsc{Bizet} Jonathan\\\textsc{Chaline} Jeremy\\ \textsc{Marguerite} Alain\\ \textsc{Rincé} Romain 
	\vspace{30mm}
}
\titlepic{\includegraphics[scale=1.00]{img/logouniv}   }
\date
{	
